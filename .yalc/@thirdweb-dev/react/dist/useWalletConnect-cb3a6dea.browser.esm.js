...
import { T as ToolTip, s as smartWalletIcon } from './Tooltip-4a6a9735.browser.esm.js';
import { utils, providers } from 'ethers';
import * as Tabs from '@radix-ui/react-tabs';
import Fuse from 'fuse.js';
import * as DropdownMenu from '@radix-ui/react-dropdown-menu';
import { Localhost } from '@thirdweb-dev/chains';
import { LocalWallet, walletIds, MetaMaskWallet, assertWindowEthereum, getInjectedMetamaskProvider, getInjectedCoinbaseProvider } from '@thirdweb-dev/wallets';
import { F as FormFieldWithIconButton, Q as QRCode, W as WalletLogoSpinner, H as HeadlessConnectUI, d as defaultWallets } from './formFields-baaf3946.browser.esm.js';
        ...
        children: /*#__PURE__*/jsxs(NetworkButton, {
          ...
          children: [/*#__PURE__*/jsx(ChainIcon, {
            ...
            children: [chainName, /*#__PURE__*/jsxs(Container, {
              ...
              }), switchingFailed && /*#__PURE__*/jsx(Text, {
                size: "xs",
                color: "danger",
...
function ReceiveFunds(props) {
  ...
  return /*#__PURE__*/jsxs(Container, {
    ...
    children: [/*#__PURE__*/jsx(ModalHeader, {
      ...
      y: "lg"
    }), !isMob ? /*#__PURE__*/jsxs(Text, {
      multiline: true,
      center: true,
      children: ["Copy the wallet address or scan the ", /*#__PURE__*/jsx("br", {}), " QR code to send funds to this wallet."]
...
const ConnectedWalletDetails = props => {
  ...
  const content = /*#__PURE__*/jsxs("div", {
    children: [/*#__PURE__*/jsxs(Container, {
      ...
      }), chain?.explorers && /*#__PURE__*/jsxs(MenuLink, {
...
function ConnectedToSmartWallet() {
  ...
  const chain = useChain();
  const address = useAddress();
  const [showConnectedToSmartWallet, setShowConnectedToSmartWallet] = useState(false);
  useEffect(() => {
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./formFields-baaf3946.browser.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./formFields-baaf3946.browser.esm.js').then(function (n) { return n.T; });
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./formFields-baaf3946.browser.esm.js').then(function (n) { return n.f; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./formFields-baaf3946.browser.esm.js').then(function (n) { return n.e; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-3a4e24a9.browser.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-0292496c.browser.esm.js').then(function (n) { return n.a; });
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-01489fbe.browser.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./formFields-baaf3946.browser.esm.js').then(function (n) { return n.g; });
