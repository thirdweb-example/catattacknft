...
import { T as ToolTip, s as smartWalletIcon } from './Tooltip-28e05219.esm.js';
...
import { F as FormFieldWithIconButton, Q as QRCode, W as WalletLogoSpinner, H as HeadlessConnectUI, d as defaultWallets } from './formFields-a21ebc5c.esm.js';
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./formFields-a21ebc5c.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./formFields-a21ebc5c.esm.js').then(function (n) { return n.T; });
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./formFields-a21ebc5c.esm.js').then(function (n) { return n.f; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./formFields-a21ebc5c.esm.js').then(function (n) { return n.e; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-d33ec12d.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-65a71eed.esm.js').then(function (n) { return n.a; });
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-f39bb8eb.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./formFields-a21ebc5c.esm.js').then(function (n) { return n.g; });
