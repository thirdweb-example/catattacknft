...
export declare abstract class BaseAccountAPI {
    ...
    encodeUserOpCallDataAndGasLimit(detailsForUserOp: TransactionDetailsForUserOp, batched: boolean): Promise<{
        callData: string;
     ...
     * @param info
     */
    createUnsignedUserOp(info: TransactionDetailsForUserOp, batched: boolean): Promise<UserOperationStruct>;
    /**
     ...
     */
    createSignedUserOp(info: TransactionDetailsForUserOp, batched: boolean): Promise<UserOperationStruct>;
    /**
