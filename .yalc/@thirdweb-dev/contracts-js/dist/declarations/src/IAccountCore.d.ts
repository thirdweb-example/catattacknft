...
export interface IAccountCoreInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "factory" | "getAllActiveSigners" | "getAllAdmins" | "getAllSigners" | "getPermissionsForSigner" | "isActiveSigner" | "isAdmin" | "multicall" | "setAdmin" | "setPermissionsForSigner" | "validateUserOp" | "verifySignerPermissionRequest"): FunctionFragment;
